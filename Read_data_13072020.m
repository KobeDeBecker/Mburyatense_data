...
F1 = 'BiomassHPLC_20200714.xlsx';
F2 = 'CTPC06603.20200714 - 5GB1 - KDB.Control.csv'; % Inoculation time seems 2 hours off?!
F3 = 'BlueVis_Export_beginning_from_2020_7_14_10_0.csv'; 
...
Data2(1:228,:) = []; % Removing lines on top
Data2(6247:end,:) = []; % removing lines on bottom
...
Inoculation_Time = '2020-07-14 13:45:00';
...
if graph
    ...
    %   Unit 1.N1.PV (stirrere speed) --> Column 35 --> 33
...
X_CH4_out = [F_in(:,1), interp1(X_CH4_out(:,1),X_CH4_out(:,2),F_in(:,1))]; 
X_O2_out = [F_in(:,1), interp1(X_O2_out(:,1),X_O2_out(:,2),F_in(:,1))]; 
X_H2O_out = [F_in(:,1), interp1(X_H2O_out(:,1),X_H2O_out(:,2),F_in(:,1))]; 
X_CO2_out = [F_in(:,1), interp1(X_CO2_out(:,1),X_CO2_out(:,2),F_in(:,1))]; 
